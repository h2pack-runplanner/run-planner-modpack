...
Shell repo for the Run Planner modpack. Contains the coordinator, shared Lib/runtime tooling submodules, and the game-module submodules for this pack.

## Structure

```text
run-planner-modpack/
|- adamantRunPlanner-RunPlanner_Modpack/ # Coordinator: pack identity, config, profiles
...
```bash
git clone --recurse-submodules https://github.com/h2pack-runplanner/run-planner-modpack.git
lua tests/smoke.lua
